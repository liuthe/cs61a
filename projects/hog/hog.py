...
def play(strategy0, strategy1, update,
    ...
    while score0<goal and score1<goal:
        roll_score0 = strategy0(score0,score1)
        score0 = update(roll_score0, score0, score1, dice)
        if score0<goal:
            roll_score1 = strategy1(score1,score0)
            score1 = update(roll_score1, score1, score0, dice)
    # END PROBLEM 5
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    score_list = []
    for i in range(10):
        score_list.append(make_averaged(roll_dice,total_samples)(i+1,dice))
    num = 0
    for j in range(10):
        if score_list[j]>score_list[num]:
            num = j
    return num+1
    # END PROBLEM 9
...
def tail_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    a,b = (opponent_score//10)%10, opponent_score%10
    if 2*abs(a-b)+1>=threshold:
        return 0
    else:
...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    a,b = (opponent_score//10)%10, opponent_score%10
    p_score = score+2*abs(a-b)+1
    if perfect_square(p_score) and (next_perfect_square(p_score)-score)>=threshold:
        r = 0
    else:
        r = num_rolls  # Remove this line once implemented.
    return r
    # END PROBLEM 11
