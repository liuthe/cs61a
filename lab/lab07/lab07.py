...
class Person:
    ...
    def __init__(self, name):
        self.name = name
        "*** YOUR CODE HERE ***"
        self.word = 'I squirreled it away before it could catch on fire.'
    ...
    def ask(self, stuff):
        self.word = "Would you please " + stuff
        return self.say("Would you please " + stuff)

    def greet(self):
        self.word = "Hello, my name is " + self.name
